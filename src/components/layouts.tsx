...
export function PageUnlogin(p: PropsWithChildren & { childrenClassName?: string, headerClassNmae?: string, type?: string }) {
    ...
    return <div className="w-full h-full flex smd:flex-col  ">
        <div className={cn("flex-[4] smd:flex-[1] smd:bg-none smd:mt-[80px]  bg-[url(/mainBg.png)] bg-no-repeat bg-cover bg-center  md:min-h-full  smd:h-full basis-0 flex flex-col justify-center items-center md:overflow-auto smd:gap-5 gap-16 lg:gap-32 text-base", p.headerClassNmae)}>
            ...
            <button className="underline underline-offset-1 text-white mt-5 smd:hidden">Learn More</button>
        </div>
