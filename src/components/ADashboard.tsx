    ...
    <div className="  overflow-hidden m-auto flex justify-center flex-col xs:w-full ">
      <div className={cn(` flex h-[3.75rem] bg-[#373737]   smd:fixed  top-0 flex-row w-full justify-between items-center py-5   px-[50px] smd:px-5 `, {
        ...
        <div className="flex  gap-5 smd:gap-[.625rem]  smd:w-full smd:justify-center h-7">
          <img src="https://aro.network/aro-logo.svg" className={` w-[12.8125rem]  smd:w-[7.5rem] h-7 `} alt="Logo" />
      ...
      <div className={cn(`h-full  nodes mb-10 smd:mt-[3.75rem]`, {
        '!mb-0': currentTab.name === 'Leaderboard'
      })}>
        <div className={cn('w-container m-auto flex justify-center xs:w-full smd:w-full xs:px-[104px] px-[3.125rem] smd:px-5 overflow-auto', {
          '!overflow-hidden': currentTab.name === 'Leaderboard'
        })}>
