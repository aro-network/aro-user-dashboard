"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[756],{20756:function(e,t,i){i.r(t),i.d(t,{W3mSendSelectTokenView:function(){return j},W3mWalletSendPreviewView:function(){return K},W3mWalletSendView:function(){return A}});var o=i(45352),r=i(46491),n=i(67994),a=i(1911),s=i(66879),l=i(994),c=i(57750),u=i(14810);i(11908),i(28052),i(76129);var d=i(31183),p=i(76711);i(73356),i(34595);var h=(0,o.iv)`
  :host {
    width: 100%;
    height: 100px;
...
`,w=function(e,t,i,o){var r,n=arguments.length,a=n<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,i):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,i,o);else for(var s=e.length-1;s>=0;s--)(r=e[s])&&(a=(n<3?r(a):n>3?r(t,i,a):r(t,i))||a);return n>3&&a&&Object.defineProperty(t,i,a),a};let g=class extends o.oi{constructor(){super(...arguments),this.inputElementRef=(0,d.V)(),this.instructionElementRef=(0,d.V)(),this.instructionHidden=!!this.value,this.pasting=!1,this.onDebouncedSearch=l.j.debounce(async e=>{let t=await p.ConnectionController.getEnsAddress(e);if(n.S.setLoading(!1),t){n.S.setReceiverProfileName(e),n.S.setReceiverAddress(t);let i=await p.ConnectionController.getEnsAvatar(e);n.S.setReceiverProfileImageUrl(i||void 0)}else n.S.setReceiverAddress(e),n.S.setReceiverProfileName(void 0),n.S.setReceiverProfileImageUrl(void 0)})}firstUpdated(){this.value&&(this.instructionHidden=!0),this.checkHidden()}render(){return(0,o.dy)` <wui-flex
...
`,k=function(e,t,i,o){var r,n=arguments.length,a=n<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,i):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,i,o);else for(var s=e.length-1;s>=0;s--)(r=e[s])&&(a=(n<3?r(a):n>3?r(t,i,a):r(t,i))||a);return n>3&&a&&Object.defineProperty(t,i,a),a};let y=class extends o.oi{constructor(){super(...arguments),this.inputElementRef=(0,d.V)(),this.disabled=!1,this.value="",this.placeholder="0"}render(){return this.inputElementRef?.value&&this.value&&(this.inputElementRef.value.value=this.value),(0,o.dy)`<input
      ${(0,d.i)(this.inputElementRef)}
      type="text"
      inputmode="decimal"
      pattern="[0-9,.]*"
...
`,R=function(e,t,i,o){var r,n=arguments.length,a=n<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,i):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,i,o);else for(var s=e.length-1;s>=0;s--)(r=e[s])&&(a=(n<3?r(a):n>3?r(t,i,a):r(t,i))||a);return n>3&&a&&Object.defineProperty(t,i,a),a};let A=class extends o.oi{constructor(){super(),this.unsubscribe=[],this.token=n.S.state.token,this.sendTokenAmount=n.S.state.sendTokenAmount,this.receiverAddress=n.S.state.receiverAddress,this.receiverProfileName=n.S.state.receiverProfileName,this.loading=n.S.state.loading,this.message="Preview Send",this.fetchNetworkPrice(),this.fetchBalances(),this.unsubscribe.push(n.S.subscribe(e=>{this.token=e.token,this.sendTokenAmount=e.sendTokenAmount,this.receiverAddress=e.receiverAddress,this.receiverProfileName=e.receiverProfileName,this.loading=e.loading}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){return this.getMessage(),(0,o.dy)` <wui-flex flexDirection="column" .padding=${["0","l","l","l"]}>
    ...
    </wui-flex>`}async fetchBalances(){await n.S.fetchTokenBalance(),n.S.fetchNetworkBalance()}async fetchNetworkPrice(){await a.nY.getNetworkTokenPrice()}onButtonClick(){s.RouterController.push("WalletSendPreview")}getMessage(){this.message="Preview Send",this.receiverAddress&&!l.j.isAddress(this.receiverAddress,c.R.state.activeChain)&&(this.message="Invalid Address"),this.receiverAddress||(this.message="Add Address"),this.sendTokenAmount&&this.token&&this.sendTokenAmount>Number(this.token.quantity.numeric)&&(this.message="Insufficient Funds"),this.sendTokenAmount||(this.message="Add Amount"),this.sendTokenAmount&&this.token?.price&&!(this.sendTokenAmount*this.token.price)&&(this.message="Incorrect Value"),this.token||(this.message="Select Token")}};A.styles=T,R([(0,r.SB)()],A.prototype,"token",void 0),R([(0,r.SB)()],A.prototype,"sendTokenAmount",void 0),R([(0,r.SB)()],A.prototype,"receiverAddress",void 0),R([(0,r.SB)()],A.prototype,"receiverProfileName",void 0),R([(0,r.SB)()],A.prototype,"loading",void 0),R([(0,r.SB)()],A.prototype,"message",void 0),A=R([(0,u.Mo)("w3m-wallet-send-view")],A),i(91936),i(40680),i(36566);var P=(0,o.iv)`
  .contentContainer {
    height: 440px;
    overflow: scroll;
...
`,L=function(e,t,i,o){var r,n=arguments.length,a=n<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,i):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,i,o);else for(var s=e.length-1;s>=0;s--)(r=e[s])&&(a=(n<3?r(a):n>3?r(t,i,a):r(t,i))||a);return n>3&&a&&Object.defineProperty(t,i,a),a};let W=class extends o.oi{constructor(){super(...arguments),this.imageSrc=void 0,this.textTitle="",this.textValue=void 0}render(){return(0,o.dy)`
...
`,F=function(e,t,i,o){var r,n=arguments.length,a=n<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,i):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,i,o);else for(var s=e.length-1;s>=0;s--)(r=e[s])&&(a=(n<3?r(a):n>3?r(t,i,a):r(t,i))||a);return n>3&&a&&Object.defineProperty(t,i,a),a};let _=class extends o.oi{render(){return(0,o.dy)` <wui-text variant="small-400" color="fg-200">Details</wui-text>
      ...
      ></wui-list-content>`:null}onNetworkClick(e){e&&s.RouterController.push("Networks",{network:e})}};_.styles=q,F([(0,r.Cb)()],_.prototype,"receiverAddress",void 0),F([(0,r.Cb)({type:Object})],_.prototype,"caipNetwork",void 0),_=F([(0,u.Mo)("w3m-wallet-send-details")],_);var Y=(0,o.iv)`
  wui-avatar,
  wui-image {
    display: ruby;
    width: 32px;
...
`,Z=function(e,t,i,o){var r,n=arguments.length,a=n<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,i):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,i,o);else for(var s=e.length-1;s>=0;s--)(r=e[s])&&(a=(n<3?r(a):n>3?r(t,i,a):r(t,i))||a);return n>3&&a&&Object.defineProperty(t,i,a),a};let K=class extends o.oi{constructor(){super(),this.unsubscribe=[],this.token=n.S.state.token,this.sendTokenAmount=n.S.state.sendTokenAmount,this.receiverAddress=n.S.state.receiverAddress,this.receiverProfileName=n.S.state.receiverProfileName,this.receiverProfileImageUrl=n.S.state.receiverProfileImageUrl,this.caipNetwork=c.R.state.activeCaipNetwork,this.loading=n.S.state.loading,this.unsubscribe.push(n.S.subscribe(e=>{this.token=e.token,this.sendTokenAmount=e.sendTokenAmount,this.receiverAddress=e.receiverAddress,this.receiverProfileName=e.receiverProfileName,this.receiverProfileImageUrl=e.receiverProfileImageUrl,this.loading=e.loading}),c.R.subscribeKey("activeCaipNetwork",e=>this.caipNetwork=e))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){return(0,o.dy)` <wui-flex flexDirection="column" .padding=${["0","l","l","l"]}>
    ...
    >`}sendValueTemplate(){if(this.token&&this.sendTokenAmount){let e=this.token.price*this.sendTokenAmount;return(0,o.dy)`<wui-text variant="paragraph-400" color="fg-100"
      ...
      >`}return null}async onSendClick(){if(!this.sendTokenAmount||!this.receiverAddress){B.SnackController.showError("Please enter a valid amount and receiver address");return}try{await n.S.sendToken(),B.SnackController.showSuccess("Transaction started"),s.RouterController.replace("Account")}catch(i){B.SnackController.showError("Failed to send transaction. Please try again."),console.error("SendController:sendToken - failed to send transaction",i);let e=c.R.state.activeChain,t=i instanceof Error?i.message:"Unknown error";E.X.sendEvent({type:"track",event:"SEND_ERROR",properties:{message:t,isSmartAccount:I.AccountController.state.preferredAccountTypes?.[e]===M.y_.ACCOUNT_TYPES.SMART_ACCOUNT,token:this.token?.symbol||"",amount:this.sendTokenAmount,network:c.R.state.activeCaipNetwork?.caipNetworkId||""}})}}onCancelClick(){s.RouterController.goBack()}};K.styles=Y,Z([(0,r.SB)()],K.prototype,"token",void 0),Z([(0,r.SB)()],K.prototype,"sendTokenAmount",void 0),Z([(0,r.SB)()],K.prototype,"receiverAddress",void 0),Z([(0,r.SB)()],K.prototype,"receiverProfileName",void 0),Z([(0,r.SB)()],K.prototype,"receiverProfileImageUrl",void 0),Z([(0,r.SB)()],K.prototype,"caipNetwork",void 0),Z([(0,r.SB)()],K.prototype,"loading",void 0),K=Z([(0,u.Mo)("w3m-wallet-send-preview-view")],K)},76129:function(e,t,i){i(518)},8524:function(e,t,i){var o=i(45352),r=i(46491),n=i(3001);i(39045);var a=i(73616),s=i(46454),l=(0,o.iv)`
  button {
...
`,c=function(e,t,i,o){var r,n=arguments.length,a=n<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,i):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,i,o);else for(var s=e.length-1;s>=0;s--)(r=e[s])&&(a=(n<3?r(a):n>3?r(t,i,a):r(t,i))||a);return n>3&&a&&Object.defineProperty(t,i,a),a};let u=class extends o.oi{constructor(){super(...arguments),this.tabIdx=void 0,this.disabled=!1,this.color="inherit"}render(){return(0,o.dy)`
    ...
    `}};u.styles=[a.ET,a.ZM,l],c([(0,r.Cb)()],u.prototype,"tabIdx",void 0),c([(0,r.Cb)({type:Boolean})],u.prototype,"disabled",void 0),c([(0,r.Cb)()],u.prototype,"color",void 0),c([(0,s.M)("wui-link")],u)},40680:function(e,t,i){var o=i(45352),r=i(46491);i(88896),i(95789),i(39045),i(87746);var n=i(73616),a=i(24441),s=i(46454),l=(0,o.iv)`
  button {
...
`,c=function(e,t,i,o){var r,n=arguments.length,a=n<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,i):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,i,o);else for(var s=e.length-1;s>=0;s--)(r=e[s])&&(a=(n<3?r(a):n>3?r(t,i,a):r(t,i))||a);return n>3&&a&&Object.defineProperty(t,i,a),a};let u=class extends o.oi{constructor(){super(...arguments),this.imageSrc=void 0,this.alt=void 0,this.address=void 0,this.size="xl"}render(){return this.style.cssText=`
 ...
 ${e}`,null}return this.dataset.variant="default",null}};u.styles=[n.ET,l],c([(0,r.Cb)()],u.prototype,"imageSrc",void 0),c([(0,r.Cb)()],u.prototype,"alt",void 0),c([(0,r.Cb)()],u.prototype,"address",void 0),c([(0,r.Cb)()],u.prototype,"size",void 0),c([(0,s.M)("wui-avatar")],u)},7794:function(e,t,i){i.d(t,{Cv:function(){return o},Ub:function(){return n},ee:function(){return r}});let o=/[.*+?^${}()|[\]\\]/gu,r=/[0-9,.]/u,n="https://reown.com"}}]);