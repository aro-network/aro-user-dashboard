"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[5984],{65984:function(t,e,i){var r,a,o=i(45352),s=i(46491),n=i(49555),c=i(57750),l=i(32849),p=i(994),u=i(66879),d=i(41671),h=i(29113),g=i(97392),w=i(14810);i(28052),i(76129),i(8524),i(34595);var y=i(3001);i(88896),i(39045),i(87746);var x=i(73616);(r=a||(a={})).approve="approved",r.bought="bought",r.borrow="borrowed",r.burn="burnt",r.cancel="canceled",r.claim="claimed",r.deploy="deployed",r.deposit="deposited",r.execute="executed",r.mint="minted",r.receive="received",r.repay="repaid",r.send="sent",r.sell="sold",r.stake="staked",r.trade="swapped",r.unstake="unstaked",r.withdraw="withdrawn";var m=i(46454);i(95789),i(518);var f=(0,o.iv)`
  :host > wui-flex {
    display: flex;
...
`,C=function(t,e,i,r){var a,o=arguments.length,s=o<3?e:null===r?r=Object.getOwnPropertyDescriptor(e,i):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(t,e,i,r);else for(var n=t.length-1;n>=0;n--)(a=t[n])&&(s=(o<3?a(s):o>3?a(e,i,s):a(e,i))||s);return o>3&&s&&Object.defineProperty(e,i,s),s};let T=class extends o.oi{constructor(){super(...arguments),this.type="approve",this.onlyDirectionIcon=!1,this.images=[],this.price=[],this.amount=[],this.symbol=[]}render(){return(0,o.dy)`
    ...
    `}templateDescription(){let t=this.descriptions?.[0];return t?(0,o.dy)`
        ...
        `:null}};T.styles=[x.ET,$],C([(0,s.Cb)()],T.prototype,"type",void 0),C([(0,s.Cb)({type:Array})],T.prototype,"descriptions",void 0),C([(0,s.Cb)()],T.prototype,"date",void 0),C([(0,s.Cb)({type:Boolean})],T.prototype,"onlyDirectionIcon",void 0),C([(0,s.Cb)()],T.prototype,"status",void 0),C([(0,s.Cb)()],T.prototype,"direction",void 0),C([(0,s.Cb)({type:Array})],T.prototype,"images",void 0),C([(0,s.Cb)({type:Array})],T.prototype,"price",void 0),C([(0,s.Cb)({type:Array})],T.prototype,"amount",void 0),C([(0,s.Cb)({type:Array})],T.prototype,"symbol",void 0),T=C([(0,m.M)("wui-transaction-list-item")],T),i(79667);var A=i(57772),k=(0,o.iv)`
  :host {
    min-height: 100%;
  }
